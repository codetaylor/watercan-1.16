...
public class WatercanParticleSpawner
    implements WatercanBaseItem.IWatercanParticleSpawner {

  public static final WatercanBaseItem.IWatercanParticleSpawner INSTANCE = new WatercanParticleSpawner();
  ...
  private boolean canSpawnParticlesAtBlockPos(
    ...
    if (block instanceof IGrowable
      ...
      return world.getBlockState(nextPos).isNormalCube(world, nextPos)
          || nextBlock == Blocks.FARMLAND;
    }
